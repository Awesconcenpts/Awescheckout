...
*/
namespace Awesconcepts\Awescheckout\Model;
...
{
    const XPATH_FORMAT = 'awesconcepts_awescheckout/general/format';
    const XPATH_DISABLED = 'awesconcepts_awescheckout/general/disabled';
    const XPATH_HOURMIN = 'awesconcepts_awescheckout/general/hourMin';
    const XPATH_HOURMAX = 'awesconcepts_awescheckout/general/hourMax';
